...
useRouteMatch works in the same way that <Route> does. It matches the current url.

2. How would you explain form validation to someone who has never programmed before?

Form validation allows you make the user fulfill basic requirements,

3. In 1-2 sentences, define end to end testing.

End to end testing tests a program by acting like a user and making sure everything is running correctly.
